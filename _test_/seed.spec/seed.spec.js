...
describe('Database is successfully seeded', () => {
  ...
  it('function rndNumb should return random number between min and max (max and min inclusive)', () => {
    const min = 5;
    const max = 10;
  ...
  it('function gtinStr should return random string of n of length n', () => {
    const num1 = 5;
    const str1 = seed.gtinStr(num1);
    assert.equal(num1, str1.length);
  });
  it('100 products created ', () => {
    let count = 0;
